...
> #### 평가 metric: FID score
> * 지정된 pair로 생성된 2,000 장의 이미지들과 지정된 실제 이미지 2,000 간의 FID score를 측정합니다. 이때, 여성 헤어스타일로 변환한 1,000장의 이미지는 실제 여성 이미지 1,000장과 비교하고, 남성 헤어스타일로 변환한 1,000장의 이미지는 실제 남성 이미지 1,000장과 비교합니다.
> * 여성 헤어스타일에 대한 FID score와 남성 헤어 스타일에 대한 FID score를 평균낸 값을 최종 FID score로 간주합니다.
